...
<div style="">
  <img style="float:left; margin-top:20px;" src="imagers/login/logo.png">
</div>
<div id="sessionInfoDiv" style="position: absolute;right: 5px;top:10px;">
 	<c:if test="${sessionScope.user.i_user_id != null}">[<strong>${sessionScope.user.v_real_name}</strong>]，欢迎你！您使用[<strong>${sessionScope.user.ip}</strong>]IP登录！</c:if>
</div>
